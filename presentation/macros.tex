...
% \newcommand{\Poly}{\rm\textsf{P}\xspace}
\newcommand{\coNP}{\rm\textsf{coNP}\xspace}
\newcommand{\coNPHard}{\rm\textsf{coNP-hard}\xspace}
\newcommand{\coNPComplete}{\rm\textsf{coNP-complete}\xspace}
...
\newcommand{\quotient}[1]{\mathcal{Z}_{#1}}
\newcommand{\qpart}[1]{\mathfrak{C}_{#1}}
\newcommand{\eqdef}{\stackrel{\mbox{\begin{tiny}def\end{tiny}}}{=}} % =def=

\newcommand{\set}[1]{\{ #1 \}}
\newcommand{\nbisim}{\xspace\mathrel{\raisebox{.5ex}{\small\ensuremath{\underline{\!\leftrightarrow\!}^*}}}\!\!\xspace}

\newcommand{\khibisimpb}{\mathtt{KhiBisim}\xspace}
\newcommand{\pkhibisimpb}{\mathtt{PKhiBisim}\xspace}
\newcommand{\checkkhibisimpb}{\mathtt{CheckKhiBisim}\xspace}
\newcommand{\dnftautpb}{\mathtt{DNF{\text{-}}TAUT}\xspace}

\newcommand{\universalbis}{\mathfrak{B}}
