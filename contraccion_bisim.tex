...
puntos dignos de interés: en primer lugar, la cantidad de aristas de $\model_\bml$ es siempre menor o igual que las de $\model$, lo cual no está
...
recién introducidos. En primera instancia, consideremos a $\model$ como el modelo a la izquierda en la 
