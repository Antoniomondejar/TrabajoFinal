...
Una primera observación que surge a partir de este teorema es que, a diferencia de lo mencionado sobre el caso de \bml, 
...
Tomando un camino similar al de \bml, una posible propuesta sería un modelo en el que se tenga como dominio al cociente 
...
Ahora, una vez presentada la contracción por \bml-bisimulación, demostraremos el siguiente teorema que extiende dicha contracción para 
\KHilogic.
...
\begin{demostracion}
    ...
    \begin{itemize}
        ...
        Como $[w_1] \in Z(U)$, existe $w_1' \in U$ tal que $w_1' \in [w_1]$. Luego notemos que aplicando sucesivamente el \Cref{lema:bml-R-lema} 
       ...
       \begin{multicols}{2}
        ...
        \Cref{lema:bml-R-lema} tendríamos que existe $v' \in [v]$ tal que $(w_k,v') \in \R_{\sigma[k]}$ pero habíamos dicho que 
