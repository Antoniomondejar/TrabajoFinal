...
Luego, recordando la definición de $A_\model$ y de $\rho_\model$ introducida en \ref{def:Am}, presentamos el siguiente teorema 
...
Hemos presentado una contracción por bisimulación para \KHilogic la cuál produce un modelo bisimilar a su modelo asociado y, además, 
...
consideración, podemos concluir que esta segunda propuesta de contracción es adecuada y computable eficientemente.
