...
representado en Sistemas de Transición Etiquetada (\lts por sus siglas en inglés), donde las transiciones etiquetadas representan los cambios de estados 
...
\begin{definicion}[\KHilogic sobre \ultss]
    ...
    \end{tabular}
    \end{nscenter}
    donde $\truthset{\modults}{\varphi} \eqdef \{w \in \W \mid \modults,w \models \varphi\}$. El conjunto de planes $\pi$ en la claúsula semántica de $\khi(\psi,\varphi)$ es llamado
