...
La lógica de \textit{Knowing How} basada en incertidumbre toma este enfoque como punto de partida. La principal motivación por la que 
...
Una vez hechas estas consideraciones, introduciremos la lógica de \textit{Knowing How} basada en incertidumbre (\KHilogic) definiendo 
