...
lo que toda una clase de equivalencia dentro de su relación de indistinguibilidad pueda lograr.
...
($\modults,w$), un \ults punteado, es finito si y sólo si $\modults$ es finito. 
