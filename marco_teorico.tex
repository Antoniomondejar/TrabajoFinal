...
\begin{definicion}
    ...
    Luego sea $u \in \W$ y $\sigma \in \ACT^*$, se define $\R_\sigma(u) \eqdef \{v\in\W \mid (u,v) \in \R_\sigma\}$, y para $U\subseteq\W$ 
    ...
    \qquad
        \R_{\strategy}(u) \eqdef \bigcup_{\sigma \in \strategy} \R_\sigma(u),
    \qquad
...
\begin{definicion}[\KHilogic-bisimulación]\label{def:bisimulation}
    ...
    \begin{itemize}
        ...
        \begin{nscenter}
            \begin{tabular}{@{}c@{}}
                $Z(u) \eqdef \csetsc{u' \in \W'}{(u,u') \in Z}$, \qquad $Z(U) \eqdef \bigcup_{u \in U} Z(u)$.
            \end{tabular}
        \end{nscenter}
        \item Sea $u' \in \W'$ y $U' \subseteq \W'$, definimos
        \begin{nscenter}
            \begin{tabular}{@{}c@{}}
                $Z^{-1}(u') \eqdef \csetsc{u \in \W}{(u,u') \in Z}$, \qquad $Z^{-1}(U') \eqdef \bigcup_{u' \in U'} Z^{-1}(u')$.
            \end{tabular}
        \end{nscenter}
    \end{itemize}
