...
\begin{definicion}[\lts basado en la incertidumbre]
    Un \emph{\lts-multiagente basado en la incertidumbre (\ults)} sobre $\PROP$ y $\AGT$ es una tupla $\model = \tup{\W,\R,\sim,\V,\ACT}$ 
...
\begin{definicion}[\KHilogic sobre \ultss]
    ...
    \begin{tabular}{@{}l@{\;\;\;}c@{\;\;\;}l@{}}
        ...
        $\modults,w \models \khi(\psi,\varphi)$ & \iffdef & \begin{minipage}[t]{0.68\textwidth}
                                                         ...
                                                         {\centering
                                                           \begin{inline-cond-kh}\item $\truthset{\modults}{\psi} \subseteq \sexec(\strategy)$ and \item $\R_\strategy(\truthset{\modults}{\psi}) \subseteq \truthset{\modults}{\varphi}$,\end{inline-cond-kh}
                                                          }
                                                       \end{minipage}
    \end{tabular}
    \end{nscenter}
...
\begin{teorema}[\KHilogic-bisimilitud implica \KHilogic-equivalencia]\label{ref:bisim-implies-equivalence}
...
\begin{teorema}[\KHilogic-equivalencia implica \KHilogic-bisimilitud]\label{ref:finite-equivalence-implies-bisim}
