...
En este trabajo contribuimos novedosos aportes al estudio de la noción de bisimulación de \KHilogic. En primer lugar, propusimos una nueva 
...
con las nociones clásicas de bisimulación, dado que logra garantizar equivalencia lógica entre dos \ultss a partir del análisis de 
...
Finalmente, encaramos el problema de la minimización de modelos para \KHilogic. Siguiendo la estrategia utilizada para el caso de la 
...
de ellas surge del análisis de las autobisimulaciones. Particularmente, demostramos que la partición de los estados de un \ults a partir 
de su función de valuación es su autobisimulación máxima. Luego, nuestra primera propuesta de contracción ($\fcont{\model}$) consiste en 
...
Asimismo, demostramos que dado $\model$, un \ults, su contracción por \KHilogic-bisimulación $\fcont{\model}$ es computable en tiempo 
poliniomial con respecto a su tamaño. En nuestra segunda propuesta ($\model_\bml$), utilizamos la contracción por \bml-bisimulación. Cada \ults tiene naturalmente un modelo de Kripke asociado, 
...
A su vez, demostramos que ambas contracciones son correctas (producen un \ults bisimilar) y que pueden ser computadas en tiempo 
...
Por último, a partir de los resultados estudiados en \cite{Demri_Fervari_2023} en relación a la lógica de \textit{Knowing How} basada en incertidumbre, 
...
cuáles son \ults en donde la relación de indistinguibilidad sobre planes de cada agente está dada por un conjunto de autómatas finitos en lugar 
