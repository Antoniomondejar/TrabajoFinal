...
Luego, estudiamos problemas computacionales relacionados con esta noción. En primera instancia determinamos que el problema de verificar 
...
de su función de valuación ($A_\model$) es su autobisimulación máxima. Luego, nuestra primera propuesta de contracción ($\fcont{\model}$) consiste en 
...
a lenguajes regulares). Sin embargo, a nivel computacional los $\regults$ resultan más poderosos. Estos permiten representar de forma finita un conjunto 
