...
\begin{demostracion}
    ...
    \begin{itemize}
        ...
        el valor de retorno de \textsf{NotSimulates} determina el valor de retorno de \textsf{CounterexampleChecker}.
        ...
        el valor de \textit{foundWitness} permanece en 0 y \textsf{NotSimulates} devuelve 1 en la línea \ref{line:did-not-find-witness}.
        ...
        Por lo que \textsf{NotSimulates} abandona el $for$ de la línea \ref{line:for-strat-in-m'} con la variable 
    ...
    \bm{$\Leftarrow)$} Queremos ver que si existe $\tup{U,b}$ tal que la ejecución de \textsf{CounterexampleChecker} a partir de 
    ...
    \begin{itemize}
        \item $b = 1$.
            ...
            Supongamos entonces $U$ cumple con lo mencionado. Luego, se ejecuta \textsf{NotSimulates} en la línea \ref{line:not-simulates-exec}. 
            ...
            línea \ref{line:return-0} donde devuelve 0. Por lo que \textsf{CounterexampleChecker} devuelve 0 a partir de 
...
existe una \KHilogic-fórmula de tamaño polinomial que los distingue. Más aún, mencionaremos cómo \textsf{CounterexampleChecker} permite construir 
dicha fórmula.
...
Por último, veamos que es posible modificar $\textsf{CounterexampleChecker}$ para que, almacenando la información necesaria, construya 
...
Por otro lado, si la ejecución de \textit{NotSimulates} devuelve 1, es posible construir la fórmula a partir del conjunto $U$ recibido 
