...
es deseable que la misma tenga una naturaleza puramente estructural, lo cual resulta de gran importancia a la hora de 
...
\begin{demostracion}
    ...
    La función \textsc{CounterexampleChecker} en el \Cref{alg:counter-example-checker} cumple con lo requerido.
