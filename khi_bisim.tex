Como mencionamos en la anterior sección (todavía no hay nada escrito pero esta idea la saco de lo que dijo Carlos),
...
De esta discusión surge la pregunta que se encara a lo largo de esta sección. ¿Cuál es la dificultad intrínseca 
...
\begin{demostracion}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            Sea $\pi' \in \S_i'$, supongamos entonces que $Z'(U) \subseteq SE(\pi')$ y veamos que 
            $\R'_{\pi'}(Z'(U)) \not \subseteq Z'(\R_\pi(U))$.

            Notemos que como $Z'(U) \subseteq SE(\pi')$, entonces $Z'(U) \ultsExecAgi \R'_{\pi'}(Z'(U))$. Ahora bien, 
            como mencionamos que (\KHilogic-zig) falla para este caso, entonces ocurre que 
            $\R'_{\pi'}(Z'(U)) \not \subseteq Z'(T)$, pues en caso contrario $T' := \R'_{\pi'}(Z'(U))$ serviría como 
            testigo de (\KHilogic-zig).
