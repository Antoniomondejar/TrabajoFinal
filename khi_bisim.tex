...
Luego, analizando las condiciones de la \Cref{def:bisim_redefinition} en las que falla $\universalbis$, veremos que es posible construir 
...
será analizar qué condición de la \Cref{def:bisim_redefinition} no es satisfecha por $\universalbis$.
...
Ahora, consideremos las condiciones de la \Cref{def:bisim_redefinition} que podrían no ser satisfechas por $\universalbis$. Cabe destacar
