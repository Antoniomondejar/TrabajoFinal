...
\begin{demostracion}
    ...
    \begin{algorithm}
        \begin{algorithmic}
            \small
            \State{{\bf Procedure} CheckBisimilarity($\modults_1,\modults_2,\tup{U,b})$} 
            \State Compute $Z'$
                ...
                \ForAll{$S_i$}
                    \ForAll{$\pi \in \S_i$}
                        ...
                        \State $foundStrat \gets False$
                            \ForAll{$\pi' \in \S_i'$}
                                \If{$Z'(U) \subseteq SE(\pi') \wedge \R'_{\pi'}(Z'(U)) \subseteq Z'(\R_\pi(U))$}
            ...
            \Else
                ...
                \ForAll{$S_i'$}
                    \ForAll{$\pi' \in \S_i'$}
                        ...
                        \State $foundStrat \gets false$
                            \ForAll{$\pi \in \S_i$}
                                \If{$Z'^{-1}(U) \subseteq SE(\pi) \wedge \R_{\pi}(Z'^{-1}(u)) \subseteq Z'^{-1}(\R'_{\pi'}(U))$}
                                    \State $foundStrat \gets true$
                                \EndIf         
                            \EndFor
                            \If{$\neg foundStrat$}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            Veamos entonces que para cada $\pi' \in \S_i'$ ocurre que $Z'(U) \not \subseteq SE(\pi')$ o que $\R'_{\pi'}(Z'(U)) \not \subseteq Z'(\R_\pi(U))$, pues notar que si esto ocurre para cada $\pi'$ entonces el valor de $foundStrat$ permanece en $false$ y el algoritmo devuelve 0 en la línea 15.

            Sea $\pi' \in \S_i'$, supongamos entonces que $Z'(U) \subseteq SE(\pi')$ y veamos que $\R'_{\pi'}(Z'(U)) \not \subseteq Z'(\R_\pi(U))$.

            Notemos que como $Z'(U) \subseteq SE(\pi')$, entonces $Z'(U) \ultsExecAgi \R'_{\pi'}(Z'(U))$. Ahora bien, como mencionamos que (\KHilogic-zig) falla para este caso, entonces ocurre que $\R'_{\pi'}(Z'(U)) \not \subseteq Z'(T)$, pues en caso contrario $T' := \R'_{\pi'}(Z'(U))$ serviría como testigo de (\KHilogic-zig).

            Pero como $\R_\pi(U) \subseteq T$, entonces es claro que $Z'(\R_\pi(U)) \subseteq Z'(T)$. Luego como $\R'_{\pi'}(Z'(U)) \not \subseteq Z'(T)$ entonces también ocurre que $\R'_{\pi'}(Z'(U)) \not \subseteq Z'(\R_\pi(U))$, que era lo que queríamos ver.
            ...
            \item (\KHilogic-zag) Análogo al caso recién analizado.
        \end{itemize}
