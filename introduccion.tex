...
saber un robot para cumplir un objetivo? ¿Qué necesita saber un agente acerca de los demás agentes para convencerlos de un argumento?, las cuales son
...
combinarlas para alcanzar un determinado objetivo. Por este motivo, esta noción puede considerarse como una posibilidad a la hora de 
...
de un \lts pero no sepa como componerlas para construir un plan adecuado. Más aún, el agente podría ser consciente de la existencia de 
dos planes distintos pero no tener la capacidad de distinguir los efectos que estos podrían provocar.
% \medskip
...
concepto es el de caracterizar esta noción de manera puramente semántica. En 
...
En el \Cref{ch:marco-teorico} presentamos la Lógica de \textit{Knowing How} Basada en la Incertidumbre (\KHilogic) introducida en \cite{ArecesFSV25,SaraviaPHD}. 
Primero, introducimos su sintaxis y semántica; para ello presentamos la gramática que define las fórmulas que la componen y, luego, 
...
definida para esta lógica junto con sus principales propiedades y ejemplos de modelos bisimilares. Finalmente, terminamos 
...
En el \Cref{ch:contraccion} abordamos el problema de minimización de modelos para \KHilogic. 
