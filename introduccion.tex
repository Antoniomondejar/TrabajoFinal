...
la única forma en la que un agente \textbf{no} sabrá cómo lograr un objetivo será que no exista un plan que lo garantice. Sin embargo, podría 
...
estrategia utilizada para abordar las consideraciones mencionadas es extender los \ltss con una relación de indistinguibilidad sobre 
planes; de esta forma la habilidad del agente deja de depender únicamente de las posibles composiciones de acciones y pasa a entrar en 
