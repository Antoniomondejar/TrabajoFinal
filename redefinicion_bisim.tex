...
\begin{demostracion}
    ...
    Luego por \Cref{new-implies-old} sabemos que $Z$ es una \KHilogic-bisimulación, y como $(w,w') \in Z$ entonces $\modults,w \bisim \modults',w'$.
...
Notemos como el fortalecimiento de la propiedad sobre los conjuntos proposicionalmente definibles nos permite fortalecer también \Cref{new-implies-old}.
...
\begin{demostracion}
    Notar que la dirección ($\rightarrow$) está demostrada en \Cref{new-implies-old}, entonces demostremos ($\leftarrow$).
