...
\begin{lema}[\KHilogic-bisimilitud$^*$ implica \KHilogic-bisimilitud]\label{lema:new_bisim-implies-old_bisim}
...
Notemos como este lema nos permite demostrar el Teorema de Invarianza para nuestra nueva noción de bisimulación.
...
\begin{demostracion}
    ...
    Luego por \Cref{lema:new_bisim-implies-old_bisim} sabemos que $Z$ es una \KHilogic-bisimulación, y como $(w,w') \in Z$ entonces $\modults,w \bisim \modults',w'$.
...
\begin{demostracion}
    ...
    \Cref{prop:khi_definable-implies-propositionally_definable}.
...
Notemos como el fortalecimiento de la propiedad sobre los conjuntos proposicionalmente definibles nos permite fortalecer también \Cref{lema:new_bisim-implies-old_bisim}.

\begin{lema}[\KHilogic-bisimilitud implica \KHilogic-bisimilitud$^*$]\label{lema:finite-old_bisim-implies-new_bisim}
...
\begin{demostracion}
    Notar que la dirección ($\rightarrow$) está demostrada en \Cref{lema:new_bisim-implies-old_bisim}, entonces demostremos ($\leftarrow$).
...
\begin{demostracion}
    ...
    Por \Cref{lema:finite-old_bisim-implies-new_bisim} tenemos que $Z$ es una \KHilogic-bisimulación$^*$. Luego, como $(w,w') \in Z$ 
