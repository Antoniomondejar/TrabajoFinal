...
\begin{ejemplo}
    ...
    cardinalidad del conjunto de fórmulas proposicionales es también contable, luego existe algún elemento de $\mathcal{P}(\PROP)$ que no es proposicionalmente 
    definible (por una cuestión de cardinalidad). Llamemos a dicho elemento $x$.
