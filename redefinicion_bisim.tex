...
es una bisimulación.
Nuevamente, si analizamos la definición presentada en la sección anterior, podemos notar que para verificar que una relación binaria es una bisimulación
...
A partir de esta propiedad, surge la nueva definición de bisimulación que proponemos para \KHilogic. La misma hace uso del 
...
\begin{demostracion}
    Notar que la dirección \bm{$\Leftarrow)$} es un caso particular del \Cref{thm:new-bisim-implies-equiv}, por lo que nos concentraremos 
